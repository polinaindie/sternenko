...
> = {
  ...
  Опторіз: "Опторіз",
  // ДЕМО: збори без фіксованого акценту, тож колір беруть за рангом у діаграмі.
  Оптоволокно: "Оптичний Русоріз",
  Перехоплювач: "Конверт на перехоплення",
  "Нічний вихід": "Секретний RUSORIZ 2.0",
  Глушник: "Грім для ворогів",
  Наземка: "Дронвестиція",
  Ретранслятор: "Небесна інвестиція",
  // Збори закінчились — ці три теж без акценту, тож колір суто за рангом.
  Тепловізор: "HAPPY OPTORIZ",
  "Зв’язок": "HAPPY OPTORIZ",
  Логістика: "HAPPY OPTORIZ",
}
